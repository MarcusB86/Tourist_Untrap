      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-[#18181b] py-8 px-6 shadow-lg rounded-lg border border-yellow-400">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-yellow-400 focus:ring-yellow-400 border-gray-700 rounded bg-black"
                />
              ...
              <div className="text-sm">
                <Link to="/reset-password" className="font-medium text-yellow-400 hover:text-yellow-300">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#18181b] text-yellow-400">Or continue with</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="w-full inline-flex justify-center py-2 px-4 border-2 border-yellow-400 rounded-lg shadow-sm bg-black text-sm font-medium text-yellow-400 hover:bg-yellow-400 hover:text-black transition-colors"
            >
